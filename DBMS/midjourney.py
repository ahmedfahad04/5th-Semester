...
version = model.versions.get("76db3ad39fc2d7d8459417af8ac339b650920250")

# https://replicate.com/tstramer/midjourney-diffusion/versions/76db3ad39fc2d7d8459417af8ac339b650920250#input
inputs = {
    # Input prompt
